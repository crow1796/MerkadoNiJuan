<div class="contact-list-container" ng-controller="contactsController as contactsVm">
	<div class="contact-list-wrapper">
		<div class="contact-list-title">
			...
			<span class="badge badge-alert">156</span>
		</div>
		<ul class="contact-categories">
			...
			<li class="category" ng-click="contactsVm.toggleGlobalChatbox($event, null)">
				<a href="#">
					Global
				</a>
			</li>
	...
	<div class="lazy-chatboxes-container" ng-if="contactsVm.toggled">
		<div class="chatbox">
	...
	{{-- Global chatbox --}}
	<div class="lazy-chatboxes-container" ng-if="contactsVm.toggledGlobal">
		<div class="chatbox">
			<div class="chatbox-title">
				Global
				<span class="pull-right chatbox-control chatbox-control-close" ng-click="contactsVm.closeGlobalChatbox($event)">
					<span class="fa fa-times-circle"></span>
				</span>
			</div>
